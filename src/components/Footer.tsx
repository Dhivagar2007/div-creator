      ...
      <div className="container">
        <div className="footer-container">
          <div className="footer-about">
            <a href="#home" className="footer-logo">Div<span>Creater</span></a>
            <p>Innovative tech solutions for the future. We combine creativity with technical expertise to deliver exceptional results.</p>
          ...
          <div className="footer-links">
            ...
            <ul>
              ...
              <li><i className="fas fa-envelope" aria-hidden="true"></i> divcreator07@gmail.com</li>
              <li><i className="fas fa-phone-alt" aria-hidden="true"></i> +91 7548835268</li>
            </ul>
          </div>
        </div>
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Div Creater. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
